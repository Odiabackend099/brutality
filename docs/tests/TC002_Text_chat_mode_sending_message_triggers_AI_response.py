...
async def run_test():
    ...
    try:
        ...
        # -> Click on the chat widget button to open it and select text input mode
        ...
        # -> Type a valid question or prompt in the chat text input field
        frame = context.pages[-1]
        # Type a valid question or prompt in the chat text input field
        elem = frame.locator('xpath=html/body/div/div/div[3]/div/input').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('What is CallWaitingAI?')
