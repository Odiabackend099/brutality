...
async def run_test():
    ...
    try:
        ...
        # Click on Log In to start authentication for testing row-level security policies.
        ...
        # Click on Sign up to create a new account for testing row-level security policies.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div/div[4]/p/a').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Fill in Full Name, Email, Password fields and click Create Account to create a new user account.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div/form/div/div/input').nth(0)
